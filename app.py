...
# Define Model Path
MODEL_PATH = os.path.join(os.path.dirname(__file__), "best_hcec_hybrid_model_best.pth")
...
def predict():
    try:
        ...
        classification = classify_prediction(
            denorm_output[0],  # cell_density
            denorm_output[2],  # corneal_thickness
            denorm_output[1]   # cv
        )
...
if __name__ == '__main__':
    ...
    app.static_folder = 'src/dist'  # Adjust based on build output
